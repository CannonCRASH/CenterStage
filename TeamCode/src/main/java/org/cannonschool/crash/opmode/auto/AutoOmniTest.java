...
@TeleOp(name = "[test] Omniwheel Linear Auto", group = "auto/linear")
public class AutoOmniTest extends LinearOpMode  {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double axial   = 1.0;  // Note: pushing stick forward gives negative value
            double lateral =  0;
            double yaw     =  0;
