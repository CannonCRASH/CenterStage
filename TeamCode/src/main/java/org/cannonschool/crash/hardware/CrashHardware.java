...
public class CrashHardware {
    ...
    public static final HardwareMotor MOTOR_FRONT_LEFT = new HardwareMotor("front_left_motor", DcMotor.Direction.FORWARD);
    ...
    public static final HardwareMotor MOTOR_BACK_RIGHT = new HardwareMotor("back_right_motor", DcMotor.Direction.REVERSE);
}
